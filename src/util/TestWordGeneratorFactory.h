...
class TestWordGeneratorFactory : public CxxTest::TestSuite
{
 public:
  ...
  void testEmptyCreate()
  {
    ...
    TS_ASSERT(wgc);
    TS_ASSERT_EQUALS(wgc->markov_.N_init_, 2);
    ...
    TS_ASSERT(wgc2);
    TS_ASSERT_EQUALS(wgc2->markov_.N_init_, 3);
    ...
    TS_ASSERT(wgc3);
    TS_ASSERT_EQUALS(wgc3->markov_.N_init_, 5);
    ...
    TS_ASSERT(wgc6);
    TS_ASSERT_EQUALS(wgc6->markov_.N_init_,
                     WordGeneratorFactory::MAX_ORDER - 1);
  }
};
