...
class TestAsset : public CxxTest::TestSuite
{
 public:
  ...
  void testEmptyString() {
    ...
    TS_ASSERT_EQUALS(img.path(), basepath + "images/");

    TS_ASSERT_EQUALS(font.filename(), "");
    TS_ASSERT_EQUALS(font.path(), basepath + "fonts/");

    TS_ASSERT_EQUALS(mesh.filename(), "");
    TS_ASSERT_EQUALS(mesh.path(), basepath + "meshes/");

    TS_ASSERT_EQUALS(shader.filename(), "");
    TS_ASSERT_EQUALS(shader.path(), basepath + "shaders/");

    TS_ASSERT_EQUALS(sound.filename(), "");
    TS_ASSERT_EQUALS(sound.path(), basepath + "sounds/");

    TS_ASSERT_EQUALS(music.filename(), "");
    TS_ASSERT_EQUALS(music.path(), basepath + "music/");
  }
